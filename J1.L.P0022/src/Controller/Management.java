...
public class Management {
    ...
    public static void createCandidate(ArrayList<Candidate> candidates, int type) {
        ...
        while (true) {
            ...
            Candidate candidate = new Candidate(id, email, lastName, birthDate, address, phone, email, birthDate);
...
//allow user create experience
    ...
    private static void createExperience(ArrayList<Candidate> candidates, Candidate candidate) {
        ...
        candidates.add(new Experience(yearExperience, yearExperience,
...
//allow user create fresher
    public static void createFresher(ArrayList<Candidate> candidates, Candidate candidate) {
        ...
        candidates.add(new Fresher(graduationDate, graduationRank,
                candidate.getId(),candidate.getFname(), candidate.getLname(), candidate.getBirthDate(), 
